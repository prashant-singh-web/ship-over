...
function Contact_Detail_Section() {
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-5 gap-5">
        <div data-aos="zoom-in-up" className="w-full bg-gray-50 h-56 md:h-96 justify-center items-center flex flex-col space-y-5 rounded-3xl shadow ">
        ...
        <div data-aos="zoom-in-up" className="w-full h-56 bg-gray-50 md:h-96 justify-center items-center flex flex-col space-y-5 rounded-xl shadow">
        ...
        <div data-aos="zoom-in-up" className="w-full bg-gray-50 h-56 md:h-96 justify-center items-center flex flex-col space-y-5 rounded-xl shadow">
