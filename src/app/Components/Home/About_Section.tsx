...
function About_Section() {
  return (
    <div className="w-full grid grid-cols-1 lg:grid-cols-2 md:p-10 overflow-hidden">
      <div className="w-full flex flex-col p-5 space-y-5">
        <h4 data-aos="fade-right" className="text-sm font-semibold text-gray-600">Misson</h4>
        <h2 data-aos="fade-right" className="text-3xl font-extrabold">About Us</h2>
        <p data-aos="fade-right" className="text-sm leading-5 text-gray-900/80">
        ...
        <div data-aos="fade-right" className="flex flex-col md:flex-row p-5 md:space-x-5">
      ...
      <Image data-aos="fade-left" src={`/logistics.jpg`} alt="ship" width={100} height={100} unoptimized className="w-full hidden lg:block"/>
    </div>
  );
}
